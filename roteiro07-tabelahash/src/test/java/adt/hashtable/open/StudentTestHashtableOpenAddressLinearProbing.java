...
public class StudentTestHashtableOpenAddressLinearProbing {
	...
	public void setUp() throws Exception {
		...
		table3 = new HashtableOpenAddressLinearProbingImpl<HashtableElement>(3, HashFunctionClosedAddressMethod.DIVISION);
	}
	...
	public void testRemove() {
		...
		table1.insert(new HashtableElement(8));
		table1.insert(new HashtableElement(18));
		assertEquals(1, table1.getCOLLISIONS());
		assertEquals(8, table1.indexOf(new HashtableElement(8)));
		assertEquals(9, table1.indexOf(new HashtableElement(18)));

		table1.remove(new HashtableElement(8));
		table1.remove(new HashtableElement(18));
		assertEquals(-1, table1.indexOf(new HashtableElement(18)));
	}
	...
	public void testIndexOf() {
		...
		assertEquals(2, table3.indexOf(new HashtableElement(2)));
		assertEquals(0, table3.indexOf(new HashtableElement(3)));
		assertEquals(-1, table3.indexOf(new HashtableElement(4)));
	}
